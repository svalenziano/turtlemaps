...
export class Overpass {
     ...
     */
    constructor(fetcher, api = Overpass.PATHS["overpass.de"]) {
     ...
     */
    formQueryFromLayers(layers, bbox) {
        let layerQuery = "";
        for (let l of layers) {
    ...
    static extractRelationGeom(ele, filter = null) {
        const result = [];
